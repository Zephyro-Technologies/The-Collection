// The Collection — monochrome social brand marks (currentColor), matching the
// WhatsApp glyph. Custom SVGs so the console stays clean (lucide's brand icons
// are deprecated) and the treatment stays consistent on the noir footer.
